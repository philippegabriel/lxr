...
echo "*** MySQL - Creating tree database kerneldom0"
mysql -u lxr -plxrpw <<END_OF_CREATE
drop database if exists kerneldom0;
create database kerneldom0;
END_OF_CREATE

echo "*** MySQL - Configuring tables lxr_ in database kerneldom0"
